		...
		<form id="kontaktformular" class="kontaktformular" action="<?php echo $_SERVER['PHP_SELF'];?>" method="post" enctype="multipart/form-data">
			...
			<div class="row">
				<div class="col-sm-8">
					...
					<input aria-label="Company" type="text" name="company"  placeholder="Company" class="field" value="<?php echo $_POST[company]; ?>" maxlength="<?php echo $number_of_characters_company; ?>" />
				</div>
			</div>
			...
			<div class="row">
				<div class="col-sm-4 <?php if ($fehler["first_name"] != "") { echo 'error'; } ?>">
					<label class="control-label"></label>
					<input <?php if($cfg['HTML5_error_messages']) { ?> required <?php }else{ ?> onchange="checkField(this)" <?php } ?> aria-label="First Name" placeholder="First Name *" type="text" name="first_name" class="field"    value="<?php echo $_POST[first_name]; ?>" maxlength="<?php echo $number_of_characters_first_name; ?>" />
					<?php if ($fehler["first_name"] != "") { echo $fehler["first_name"]; } ?>
				</div>
				<div class="col-sm-4 <?php if ($fehler["name"] != "") { echo 'error'; } ?>">
					<label class="control-label"></label>
					<input <?php if($cfg['HTML5_error_messages']) { ?> required <?php }else{ ?> onchange="checkField(this)" <?php } ?> type="text" name="name" placeholder="Last Name *" class="field"   value="<?php echo $_POST[name]; ?>" maxlength="<?php echo $number_of_characters_name; ?>" />
			...
			<div class="row">
				<div class="col-sm-4 <?php if ($fehler["email"] != "") { echo 'error'; } ?>">
					<label class="control-label"></label>
					<input <?php if($cfg['HTML5_error_messages']) { ?> required <?php }else{ ?> onchange="checkField(this)" <?php } ?> aria-label="Email" type="<?php if($cfg['HTML5_error_messages']) { echo 'email'; }else{ echo 'text'; } ?>" name="email" class="field"  placeholder="Email *"  value="<?php echo $_POST[email]; ?>" maxlength="<?php echo $number_of_characters_email; ?>" />
					<?php if ($fehler["email"] != "") { echo $fehler["email"]; } ?>
				</div>
				<div class="col-sm-4 <?php if ($fehler["telephone"] != "") { echo 'error'; } ?>">
					<label class="control-label"></label>
					<input <?php if($cfg['HTML5_error_messages']) { ?> required <?php }else{ ?>   onchange="checkField(this)" <?php } ?> aria-label="telephone" placeholder="telephone *" type="text" name="telephone" class="field"   value="<?php echo $_POST[telephone]; ?>" maxlength="<?php echo $number_of_characters_telephone; ?>" />
					<?php if ($fehler["telephone"] != "") { echo $fehler["telephone"]; } ?>
				</div> 
			</div>
		   ...
		   <div class="row">
				<div class="col-sm-8 <?php if ($fehler["subject"] != "") { echo 'error'; } ?>">
					<label class="control-label"></label>
					<input <?php if($cfg['HTML5_error_messages']) { ?> required <?php }else{ ?>   onchange="checkField(this)" <?php } ?> aria-label="Subject" placeholder="Subject *" type="text" name="subject" class="field"   value="<?php echo $_POST[subject]; ?>" maxlength="<?php echo $number_of_characters_subject; ?>" />
			...
			<div class="row">
				<div class="col-sm-8 <?php if ($fehler["message"] != "") { echo 'error'; } ?>">
					...
					<textarea <?php if($cfg['HTML5_error_messages']) { ?> required <?php }else{ ?> onchange="checkField(this)" <?php } ?> aria-label="Message" name="message" class="field" rows="5"  placeholder="Message *"  style="height:100%;width:100%;"><?php echo $_POST[message]; ?></textarea>
