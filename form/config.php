...
$recipient = "rajindustries@msn.com";  //Please insert your email address (between the quotation marks)

$yourname = "Raj Industries";  // Please insert your name here (between the quotation marks) It will appear as the sender in the thank-you mail.
